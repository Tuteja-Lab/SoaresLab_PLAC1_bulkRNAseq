---
title: "CT27 ST3D PLAC1 KD Bulk RNAseq analyses"
date: "`r Sys.Date()`"
author:
  - name: Arun Seetharam
...
source("/work/LAS/geetu-lab/arnstrm/hTS_CT27_ST3D_PLAC1_KD/assets/de_functions.R")
```
## Gene information
...
plotPCE(inputGenes = PLAC1vsSCR.up.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#00b462")
```

### Zhou&Petropoulos (Castel)

```{r pceA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = PLAC1vsSCR.up.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#00b462")
```

### Rostovskaya (Hs)

```{r pceA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = PLAC1vsSCR.up.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#00b462")
```

### Rostovskaya (Cy)

```{r pceA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = PLAC1vsSCR.up.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#00b462")
```
...
plotPCE(inputGenes = PLAC1vsSCR.dw.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#980c80")
```

### Xiang
```{r pceB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = PLAC1vsSCR.dw.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#980c80")
```

### Zhou&Petropoulos (Castel)

```{r pceB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = PLAC1vsSCR.dw.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#980c80")
```

### Rostovskaya (Hs)

```{r pceB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = PLAC1vsSCR.dw.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#980c80")
```

### Rostovskaya (Cy)

```{r pceB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = PLAC1vsSCR.dw.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#980c80")
```
...
save(PLAC1vsSCR.up.pce1, PLAC1vsSCR.dw.pce1, file = "assets/hTS_CT27_ST3D_PLAC1_KD_genelists.RData")
```

---
title: "PLAC1 JZ 18.5 RNAseq analyses"
date: "`r Sys.Date()`"
author:
  - name: Arun Seetharam
...
conda activate star
# working dir
mkdir -p /work/LAS/geetu-lab/arnstrm/PLAC1_JZ_18.5
cd /work/LAS/geetu-lab/arnstrm/PLAC1_JZ_18.5
mkdir -p 1_data
mkdir -p 2_fastqc
...
cd 1_data
rsync -avP /lss/folder/path/PLAC1_JZ_18.5 ./1_data
...
# set path
setwd("/work/LAS/geetu-lab/arnstrm/PLAC1_JZ_18.5")
# load the modules
library(tidyverse)
library(DESeq2)
library(vsn)
...
ggplot(d, aes(PC1, PC2, color = condition)) +
  ...
  scale_color_manual(values = c('KO'	= '#00a3ba',
                                'WT' 	  = '#c20e13')) +
  theme_bw() +
...
source("/work/LAS/geetu-lab/arnstrm/PLAC1_JZ_18.5/assets/de_functions.R")
```
## Gene information
...
```{r vol1, fig.cap="Fig X: KO vs WT", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
g <- volcanoPlots(
  res.KOvsWT,
  "KOvsWT",
  "KO",
...
### KO vs. WT (interactive)

```{r vol2, fig.cap="Fig X: KO vs WT", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
ggplotly(g)
```
...
## PCE tests (up in KO) {.tabset}


### VentoTormo
```{r pceA1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#00a3ba")
```

### Xiang
```{r pceA2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#00a3ba")
```

### Zhou&Petropoulos (Castel)

```{r pceA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#00a3ba")
```

### Rostovskaya (Hs)

```{r pceA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#00a3ba")
```

### Rostovskaya (Cy)

```{r pceA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#00a3ba")
```


## PCE tests (up in WT) {.tabset}

### VentoTormo
```{r pceB1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#c20e13")
```

### Xiang
```{r pceB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#c20e13")
```

### Zhou&Petropoulos (Castel)

```{r pceB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#c20e13")
```

### Rostovskaya (Hs)

```{r pceB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#c20e13")
```

### Rostovskaya (Cy)

```{r pceB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#c20e13")
```



## Enrichment tests (up in KO) {.tabset}


### DisGeNET
```{r erA1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="DisGeNET" , myColor = "#00a3ba")
```


### GO_Biological_Process_2021
```{r erA2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="GO_Biological_Process_2021" , "#00a3ba")
```

### HDSigDB_Human_2021

```{r erA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="HDSigDB_Human_2021" , "#00a3ba")
```

### KEGG_2021_Human

```{r erA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="KEGG_2021_Human" , "#00a3ba")
```

### GTEx_Tissues_V8_2023

```{r erA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="GTEx_Tissues_V8_2023" , "#00a3ba")
```

### MGI_Mammalian_Phenotype_Level_3

```{r erA6, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="MGI_Mammalian_Phenotype_Level_3" , "#00a3ba")
```

### MGI_Mammalian_Phenotype_Level_4_2021

```{r erA7, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="MGI_Mammalian_Phenotype_Level_4_2021" , "#00a3ba")
```

### WikiPathways_2019_Human

```{r erA8, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="WikiPathways_2019_Human" , "#00a3ba")
```

### Panther_2015
   
```{r erA9, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="Panther_2015" , "#00a3ba")
```

 

## Enrichment tests (up in WT) {.tabset}


### DisGeNET
```{r erB1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="DisGeNET" , myColor = "#c20e13")
```


### GO_Biological_Process_2021
```{r erB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="GO_Biological_Process_2021" , "#c20e13")
```

### HDSigDB_Human_2021

```{r erB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="HDSigDB_Human_2021" , "#c20e13")
```

### KEGG_2021_Human

```{r erB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="KEGG_2021_Human" , "#c20e13")
```

### GTEx_Tissues_V8_2023

```{r erB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="GTEx_Tissues_V8_2023" , "#c20e13")
```

### MGI_Mammalian_Phenotype_Level_3

```{r erB6, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="MGI_Mammalian_Phenotype_Level_3" , "#c20e13")
```

### MGI_Mammalian_Phenotype_Level_4_2021

```{r erB7, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="MGI_Mammalian_Phenotype_Level_4_2021" , "#c20e13")
```

### WikiPathways_2019_Human

```{r erB8, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="WikiPathways_2019_Human" , "#c20e13")
```

### Panther_2015
   
```{r erB9, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="Panther_2015" , "#c20e13")
```
...
```{r saveInfo}
save.image(file = "assets/PLAC1_JZ_18.5.RData")
save(hsKOvsWT.up.pce1, hsKOvsWT.dw.pce1, KOvsWT.up.pce1, KOvsWT.dw.pce1, file = "assets/PLAC1_JZ_18.5_genelists.RData")
```

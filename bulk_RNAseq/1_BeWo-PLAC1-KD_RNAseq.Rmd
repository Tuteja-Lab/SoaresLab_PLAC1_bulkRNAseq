...
ggplot(d, aes(PC1, PC2, color = condition)) +
  ...
  scale_color_manual(values = c('BeWo_ctr' 		= '#e56a02',
                                'BeWo_KD' 	= '#6e93ff')) +
  theme_bw() +
...
source("/work/LAS/geetu-lab/arnstrm/BeWo_PLAC1_KD/assets/de_functions.R")
```
## Gene information
...
```{r vol1, fig.cap="Fig X: Control vs. KD", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
g <- volcanoPlots(
  res.CTvsKD,
  "CTvsKD",
  "Control",
...
```{r vol2, fig.cap="Fig X: Control vs. KD", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
ggplotly(g)
```
...
if (websiteLive) {
  CTvsKD.up.enriched <- enrichr(CTvsKD.up.pce2, myDBs)
  CTvsKD.dw.enriched <- enrichr(CTvsKD.dw.pce2, myDBs)
}
```

## PCE tests (up in CT) {.tabset}


### VentoTormo
```{r pceA1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.up.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#e56a02")
```

### Xiang
```{r pceA2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.up.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#e56a02")
```

### Zhou&Petropoulos (Castel)

```{r pceA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.up.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#e56a02")
```

### Rostovskaya (Hs)

```{r pceA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.up.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#e56a02")
```

### Rostovskaya (Cy)

```{r pceA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.up.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#e56a02")
```


## PCE tests (up in KD) {.tabset}

### VentoTormo
```{r pceB1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.dw.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#6e93ff")
```

### Xiang
```{r pceB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.dw.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#6e93ff")
```

### Zhou&Petropoulos (Castel)

```{r pceB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.dw.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#6e93ff")
```

### Rostovskaya (Hs)

```{r pceB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.dw.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#6e93ff")
```

### Rostovskaya (Cy)

```{r pceB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = CTvsKD.dw.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#6e93ff")
```


## Enrichment tests (up in control) {.tabset}


### DisGeNET
```{r erA1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="DisGeNET" , myColor = "#e56a02")
```


### GO_Biological_Process_2021
```{r erA2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="GO_Biological_Process_2021" , "#e56a02")
```

### HDSigDB_Human_2021

```{r erA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="HDSigDB_Human_2021" , "#e56a02")
```

### KEGG_2021_Human

```{r erA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="KEGG_2021_Human" , "#e56a02")
```

### GTEx_Tissues_V8_2023

```{r erA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="GTEx_Tissues_V8_2023" , "#e56a02")
```

### MGI_Mammalian_Phenotype_Level_3

```{r erA6, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="MGI_Mammalian_Phenotype_Level_3" , "#e56a02")
```

### MGI_Mammalian_Phenotype_Level_4_2021

```{r erA7, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="MGI_Mammalian_Phenotype_Level_4_2021" , "#e56a02")
```

### WikiPathways_2019_Human

```{r erA8, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="WikiPathways_2019_Human" , "#e56a02")
```

### Panther_2015
   
```{r erA9, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.up.enriched, table="Panther_2015" , "#e56a02")
```

 

## Enrichment tests (up in KD) {.tabset}


### DisGeNET
```{r erB1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="DisGeNET" , myColor = "#6e93ff")
```


### GO_Biological_Process_2021
```{r erB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="GO_Biological_Process_2021" , "#6e93ff")
```

### HDSigDB_Human_2021

```{r erB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="HDSigDB_Human_2021" , "#6e93ff")
```

### KEGG_2021_Human

```{r erB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="KEGG_2021_Human" , "#6e93ff")
```

### GTEx_Tissues_V8_2023

```{r erB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="GTEx_Tissues_V8_2023" , "#6e93ff")
```

### MGI_Mammalian_Phenotype_Level_3

```{r erB6, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="MGI_Mammalian_Phenotype_Level_3" , "#6e93ff")
```

### MGI_Mammalian_Phenotype_Level_4_2021

```{r erB7, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="MGI_Mammalian_Phenotype_Level_4_2021" , "#6e93ff")
```

### WikiPathways_2019_Human

```{r erB8, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="WikiPathways_2019_Human" , "#6e93ff")
```

### Panther_2015
   
```{r erB9, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(CTvsKD.dw.enriched, table="Panther_2015" , "#6e93ff")
```
...
save(CTvsKD.up.pce1, CTvsKD.dw.pce1, file = "assets/BeWo_PLAC1_KD_genelists.RData")
```

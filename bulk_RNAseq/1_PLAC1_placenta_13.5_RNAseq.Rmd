...
ggplot(d, aes(PC1, PC2, color = condition)) +
  ...
  scale_color_manual(values = c('PLAC1.KO'	= '#ff8b5b',
                                'PLAC1.WT' 	= '#01c499')) +
  theme_bw() +
...
source("/work/LAS/geetu-lab/arnstrm/PLAC1_placenta_13.5/assets/de_functions.R")
```
## Gene information
...
### PLAC1.KO vs. PLAC1.WT

```{r vol1, fig.cap="Fig X: PLAC1.KO vs PLAC1.WT", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
g <- volcanoPlots(
  res.KOvsWT,
  "KOvsWT",
  "PLAC1.KO",
...
```{r vol2, fig.cap="Fig X: PLAC1.KO", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
ggplotly(g)
```
...
## PCE tests (up in PLAC1.KO) {.tabset}


### VentoTormo
```{r pceA1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#ff8b5b")
```

### Xiang
```{r pceA2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#ff8b5b")
```

### Zhou&Petropoulos (Castel)

```{r pceA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#ff8b5b")
```

### Rostovskaya (Hs)

```{r pceA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#ff8b5b")
```

### Rostovskaya (Cy)

```{r pceA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.up.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#ff8b5b")
```


## PCE tests (up in PLAC1.WT) {.tabset}


### VentoTormo
```{r pceB1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#01c499")
```

### Xiang
```{r pceB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#01c499")
```

### Zhou&Petropoulos (Castel)

```{r pceB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#01c499")
```

### Rostovskaya (Hs)

```{r pceB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#01c499")
```

### Rostovskaya (Cy)

```{r pceB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsKOvsWT.dw.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#01c499")
```




## Other enrichment tests (up in PLAC1.KO) {.tabset}

### DisGeNET
```{r erA1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="DisGeNET" , myColor = "#ff8b5b")
```


### GO_Biological_Process_2021
```{r erA2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="GO_Biological_Process_2021" , "#ff8b5b")
```

### HDSigDB_Human_2021

```{r erA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="HDSigDB_Human_2021" , "#ff8b5b")
```

### KEGG_2021_Human

```{r erA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="KEGG_2021_Human" , "#ff8b5b")
```

### GTEx_Tissues_V8_2023

```{r erA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="GTEx_Tissues_V8_2023" , "#ff8b5b")
```

### MGI_Mammalian_Phenotype_Level_3

```{r erA6, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="MGI_Mammalian_Phenotype_Level_3" , "#ff8b5b")
```

### MGI_Mammalian_Phenotype_Level_4_2021

```{r erA7, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="MGI_Mammalian_Phenotype_Level_4_2021" , "#ff8b5b")
```

### WikiPathways_2019_Human

```{r erA8, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="WikiPathways_2019_Human" , "#ff8b5b")
```

### Panther_2015
   
```{r erA9, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.up.enriched, table="Panther_2015" , "#ff8b5b")
```

 

## Other enrichment tests (up in PLAC1.WT) {.tabset}


### DisGeNET
```{r erB1, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="DisGeNET" , myColor = "#01c499")
```


### GO_Biological_Process_2021
```{r erB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="GO_Biological_Process_2021" , "#01c499")
```

### HDSigDB_Human_2021

```{r erB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="HDSigDB_Human_2021" , "#01c499")
```

### KEGG_2021_Human

```{r erB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="KEGG_2021_Human" , "#01c499")
```

### GTEx_Tissues_V8_2023

```{r erB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="GTEx_Tissues_V8_2023" , "#01c499")
```

### MGI_Mammalian_Phenotype_Level_3

```{r erB6, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="MGI_Mammalian_Phenotype_Level_3" , "#01c499")
```

### MGI_Mammalian_Phenotype_Level_4_2021

```{r erB7, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="MGI_Mammalian_Phenotype_Level_4_2021" , "#01c499")
```

### WikiPathways_2019_Human

```{r erB8, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="WikiPathways_2019_Human" , "#01c499")
```

### Panther_2015
   
```{r erB9, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotEnrichR(KOvsWT.dw.enriched, table="Panther_2015" , "#01c499")
```

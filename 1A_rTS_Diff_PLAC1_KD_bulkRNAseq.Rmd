...
source("/work/LAS/geetu-lab/arnstrm/rTS_Diff_PLAC1_KD/assets/de_functions.R")
```
## Gene information
...
processDE(res.PLCvsSCR, "PLAC1vsSCR")
```
...
```{r vol1, fig.cap="Fig X: PLAC1 vs SCR", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
g <- volcanoPlots(
  res.PLCvsSCR,
  "PLAC1vsSCR",
  "PLAC1",
...
```{r vol2, fig.cap="Fig X: PLAC1 vs. SCR", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
ggplotly(g)
...
plotPCE(inputGenes = hsPLAC1vsSCR.up.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#00b462")
```

### Xiang
```{r pceA2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.up.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#00b462")
```

### Zhou&Petropoulos (Castel)

```{r pceA3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.up.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#00b462")
```

### Rostovskaya (Hs)

```{r pceA4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.up.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#00b462")
```

### Rostovskaya (Cy)

```{r pceA5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.up.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#00b462")
```
...
plotPCE(inputGenes = hsPLAC1vsSCR.dw.pce1, dataBG = teVt, cellInfo = md.vt, myColor = "#980c80")
```

### Xiang
```{r pceB2, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.dw.pce2, dataBG = teXi, cellInfo = md.xi, myColor = "#980c80")
```

### Zhou&Petropoulos (Castel)

```{r pceB3, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.dw.pce2, dataBG = teZp, cellInfo = md.zp, myColor = "#980c80")
```

### Rostovskaya (Hs)

```{r pceB4, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.dw.pce2, dataBG = teRo.hs, cellInfo = md.ro, myColor = "#980c80")
```

### Rostovskaya (Cy)

```{r pceB5, fig.cap="", fig.width=12, fig.height=5, warnings=FALSE, message=FALSE}
plotPCE(inputGenes = hsPLAC1vsSCR.dw.pce2, dataBG = teRo.cy, cellInfo = md.ro, myColor = "#980c80")
```


## Enrichment tests (up in PLAC1) {.tabset}

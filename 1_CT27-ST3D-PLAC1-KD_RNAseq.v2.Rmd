...
processDE.ver(res.PLCvsSCR, "PLAC1vsSCR")
```
...
```{r vol2, fig.cap="Fig X: PLAC1 vs SCR (purple/negFC = overexpressed in SCR; green/posFC = overexpressed in PLAC1)", fig.width=8, fig.height=5, warnings=FALSE, message=FALSE}
ggplotly(g)
```
...
knitr::include_graphics("hsa04814.pathview.png")
```
